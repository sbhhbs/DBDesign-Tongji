...
namespace crazy
{
    public class InStationHttpRequestHandler : HttpRequestHandler
    {
        public const string NAME = "/InStation";
        ...
        public void Handle(HttpListenerContext context)
        {
            ...
            string stationname = HttpUtility.UrlDecode((context.Request.QueryString["stationName"]), Encoding.Unicode);
            ...
            if (card.inorout_station(cardid,stationid,0))
            {
                istrue = true;
            }
            else
